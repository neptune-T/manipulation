        ...
        for step in range(int(args.steps)):
            ...
            if step % 10 == 0 or done:
                print(
                    ...
                    f"pinch_r={step_info['reward_terms']['pinch']:.3f} gate={step_info['reward_terms']['pinch_gate']:.3f} "
                    f"fc_r={step_info['reward_terms']['force_closure']:.3f} fc_g={step_info['reward_terms']['force_closure_gate']:.3f} "
                    f"min_dist={step_info['surface_contact_min_dist']:.4f} pen={step_info['reward_terms']['penetration_penalty']:.4f} palm_pen={step_info['reward_terms']['palm_penalty']:.4f} "
